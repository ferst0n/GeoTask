...
@AndroidEntryPoint
class EndPointFragment:Fragment(), OnMapReadyCallback {

    private lateinit var mMap: GoogleMap
    private val endPointViewModel: EndPointViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_end_point, container, false)
        ...
        endPointViewModel.place.observe(viewLifecycleOwner, {
        ...
        autoCompleteTextView.setOnItemClickListener { parent, view, position, id ->
            ...
            passDataBetweenFragmentsViewModel.setDestinationId(selectedPlaceId!!)

            getPlaceDetails(selectedPlaceId)

            endPointViewModel.placeDetails.observe(viewLifecycleOwner){
    ...
    private fun setMarker(location: Location,selectedPlaceName:String){
        ...
        endPointViewModel.setMarkerOptions(markerOptions)
    }

    private fun getPlaceNamePredicts(enteredPlace: String) {
        lifecycleScope.launch {
            endPointViewModel.getPlaceNamePredicts(enteredPlace)
        }
    }

    private fun getPlaceDetails(placeId: String){
        lifecycleScope.launch {
            endPointViewModel.getPlaceDetails(placeId)
        }
    }
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        if (endPointViewModel.getMarkerOptions() != null){
            var markerOptions = endPointViewModel.getMarkerOptions()
            mMap.addMarker(markerOptions)
        }
